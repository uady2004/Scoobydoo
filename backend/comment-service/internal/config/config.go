...
type KafkaTopics struct {
	...
	CommentLiked   string `mapstructure:"comment_liked"`
}
...
func Load() (*Config, error) {
	...
	v.AddConfigPath("/etc/comment-service/")
	v.AddConfigPath(".")

	v.SetEnvPrefix("COMMENT")
...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("database.url", "postgres://postgres:postgres@localhost:5432/tiktok_comments?sslmode=disable")
	...
	v.SetDefault("kafka.topics.comment_liked", "comment.liked")
